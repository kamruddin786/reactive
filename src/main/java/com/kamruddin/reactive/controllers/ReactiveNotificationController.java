...
import com.kamruddin.reactive.services.StreamNotificationConsumer;
...
public class ReactiveNotificationController {
    ...
    public Flux<ServerSentEvent<StreamNotificationConsumer.MessageNotification>> streamNotificationsViaStreams(
            @PathVariable Long userId,
    ...
    public ResponseEntity<Map<String, Object>> getStreamPendingMessages(@PathVariable Long userId) {
        try {
            java.util.List<StreamNotificationConsumer.MessageNotification> pendingMessages =
